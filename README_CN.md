...
方式1：通过 Gitee 脚本
```bash
bash <(curl -Lk https://gitee.com/XM-LEES/cursor-vip/releases/download/latest/ic.sh) githubReadme
```
方式2：通过 GitHub 脚本
```bash
bash <(curl -Lk https://github.com/XM-LEES/cursor-vip/releases/download/latest/i.sh) githubReadme
```
方式3：手动下载二进制文件
